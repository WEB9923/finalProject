      ...
      <>
         <div className="filter-content">
            ...
            <div className="filter-wrapper">
               <button className={`show-category ${showCategory && "touchedActive"}`}
                       onClick={() => setShowCategory(!showCategory)}>category <BiChevronDown size={25}/></button>
               ...
               <button className={`show-brand ${showBrand && "touchedActive"}`} style={{marginTop: "20px"}}
                       onClick={() => setShowBrand(!showBrand)}>brand <BiChevronDown size={25}/></button>
